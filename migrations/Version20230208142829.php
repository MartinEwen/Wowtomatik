 ...
 */
final class Version20230208142829 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE applicant (id INT AUTO_INCREMENT NOT NULL, guild_id INT DEFAULT NULL, characters_id INT DEFAULT NULL, accept TINYINT(1) NOT NULL, INDEX IDX_CAAD10195F2131EF (guild_id), INDEX IDX_CAAD1019C70F0E28 (characters_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE characters (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, guilds_id INT DEFAULT NULL, race_id INT NOT NULL, classe_id INT NOT NULL, name_character VARCHAR(50) DEFAULT NULL, lvl_character SMALLINT DEFAULT NULL, gear_score_spe1 SMALLINT DEFAULT NULL, gear_score_spe2 SMALLINT DEFAULT NULL, role_guild VARCHAR(50) DEFAULT NULL, UNIQUE INDEX UNIQ_3A29410EEF8A8E76 (name_character), INDEX IDX_3A29410EA76ED395 (user_id), INDEX IDX_3A29410ED79B63FD (guilds_id), INDEX IDX_3A29410E6E59D40D (race_id), INDEX IDX_3A29410E8F5EA509 (classe_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE guilds (id INT AUTO_INCREMENT NOT NULL, name_guild VARCHAR(50) DEFAULT NULL, created_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `kill` (id INT AUTO_INCREMENT NOT NULL, guild_id INT DEFAULT NULL, boss_id INT DEFAULT NULL, alive TINYINT(1) DEFAULT NULL, picture VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, INDEX IDX_72956695F2131EF (guild_id), INDEX IDX_7295669261FB672 (boss_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE specialisation (id INT AUTO_INCREMENT NOT NULL, classe_id INT NOT NULL, name VARCHAR(255) NOT NULL, picture VARCHAR(255) NOT NULL, INDEX IDX_B9D6A3A28F5EA509 (classe_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE applicant ADD CONSTRAINT FK_CAAD10195F2131EF FOREIGN KEY (guild_id) REFERENCES guilds (id)');
        $this->addSql('ALTER TABLE applicant ADD CONSTRAINT FK_CAAD1019C70F0E28 FOREIGN KEY (characters_id) REFERENCES characters (id)');
        ...
        $this->addSql('ALTER TABLE `kill` ADD CONSTRAINT FK_72956695F2131EF FOREIGN KEY (guild_id) REFERENCES guilds (id)');
        $this->addSql('ALTER TABLE `kill` ADD CONSTRAINT FK_7295669261FB672 FOREIGN KEY (boss_id) REFERENCES boss (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE applicant DROP FOREIGN KEY FK_CAAD10195F2131EF');
        $this->addSql('ALTER TABLE applicant DROP FOREIGN KEY FK_CAAD1019C70F0E28');
        ...
        $this->addSql('ALTER TABLE `kill` DROP FOREIGN KEY FK_72956695F2131EF');
        $this->addSql('ALTER TABLE `kill` DROP FOREIGN KEY FK_7295669261FB672');
